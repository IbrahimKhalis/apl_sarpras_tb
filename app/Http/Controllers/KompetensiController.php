...
class KompetensiController extends Controller
{
    ...
    {
         $this->middleware('permission:view_kompetensi', ['only' => ['index','show']]);
    ...
    public function store(StoreKompetensiRequest $request)
    {
        ...
        return TahunAjaran::redirectWithTahunAjaran('kompetensi.index', $request, 'Berhasil disimpan!');
    }
    ...
    public function update(UpdateKompetensiRequest $request, Kompetensi $kompetensi)
    {
        if ($kompetensi->sekolah_id == \Auth::user()->sekolah->id) {
            ...
            return TahunAjaran::redirectWithTahunAjaran('kompetensi.index', $request, 'Berhasil diubah!');
        }
